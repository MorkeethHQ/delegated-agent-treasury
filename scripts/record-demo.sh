#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════════
# Yieldbound — Screen Recording Demo
# ═══════════════════════════════════════════════════════════════════
...
echo ""
echo -e "  ${D}10 packages · 25 MCP tools · 39 API endpoints${X}"
...
echo -e "  ${C}Claude${X} — AI agent (CLI) — 10-package TypeScript system, 25 MCP tools"
echo ""
...
echo -e "  ${C}Claude${X}  10 packages, 25 tools, 39 APIs ${D}(AI agent — CLI)${X}"
echo ""
sleep 2
echo -e "  ${D}Zero lines of human-written code.${X}"
