...
echo -e "${BOLD}║                                                                ║${RESET}"
echo -e "${BOLD}║   Live on Base mainnet • 35 API endpoints • 17 on-chain TXs   ║${RESET}"
...
echo -e "${BOLD}╠════════════════════════════════════════════════════════════════╣${RESET}"
echo -e "${BOLD}║  17 mainnet transactions across Base + Celo                   ║${RESET}"
echo -e "${BOLD}║  3 AUTONOMOUS spendYield TXs — zero human intervention       ║${RESET}"
